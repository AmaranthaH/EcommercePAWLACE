...
signupForm.addEventListener('submit', (e) => {
    ...
    if (password === passwordValid) {
        ...
        mostrarUsuarios(); // Llama a la función para actualizar la tabla después de registrar un nuevo usuario
        // Redireccion al login si es necesario
        // window.location.href = 'login.html'; // Descomentar si se desea redirigir a una página de login
    } else {
        // Establecer el mensaje de error si las contraseñas no coinciden y notifica
