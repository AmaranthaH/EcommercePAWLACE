...
document.querySelectorAll('.btn-primary').forEach(button => {
    button.addEventListener('click', () => {
        ...
        // Dentro de la función que agrega un producto al carrito
        const messageContainer2 = document.getElementById('messageContainer2'); // Obtener el contenedor del mensaje
        messageContainer2.innerHTML = '<p class="success-message">Producto agregado al carrito</p>'; // Agregar el mensaje al contenedor
        messageContainer2.classList.remove('hidden'); // Mostrar el contenedor del mensaje

        // Hacer que el mensaje desaparezca después de 3 segundos
        setTimeout(() => {
            messageContainer2.innerHTML = ''; // Limpiar el contenido del contenedor de mensajes
            messageContainer2.classList.add('hidden'); // Ocultar el contenedor del mensaje nuevamente
        }, 1500); // 3000 milisegundos = 3 segundos
